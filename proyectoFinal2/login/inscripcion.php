    ...
    <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
            <div class="col-lg-6">
                <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="inscripcion.php" method="POST">
                    ...
                    <div class="form-floating mb-3">
                        <input class="form-control" id="name" type="text" name="apellidopat">
                        <label for="name">Apellido Paterno</label>
                        <div class="invalid-feedback" data-sb-feedback="name:required">No introdujiste el nombre del alumno.</div>
                    </div>

                    <div class="form-floating mb-3">
                        <input class="form-control" id="email" type="text" name="apellidomat">
...
$apellido_mat = isset($_POST['apellidomat'])?$_POST['apellidomat']:null;
$salud  = isset($_POST['salud'])?$_POST['salud']:null;
$apellido_pat = isset($_POST['apellidopat'])?$_POST['apellidopat']:null;
